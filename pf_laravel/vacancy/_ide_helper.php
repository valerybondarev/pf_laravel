...
')
     ...
     */ 
         ...
         *
         * @param array $options
         * @return \Laraeast\LaravelBootstrapForms\HtmlString 
         * @static 
         */ 
        public static function open($options = [])
        {
         ...
         *
         * @param \Laraeast\LaravelBootstrapForms\Model $model
         * @param array $options
         * @return \Laraeast\LaravelBootstrapForms\HtmlString 
         * @static 
         */ 
         ...
         * @static 
         */ 
        public static function putModel($model, $options = [])
        {
                        /** @var \Laraeast\LaravelBootstrapForms\BsForm $instance */
                        return $instance->putModel($model, $options);
        }
                    /**
         ...
         * @static 
         */ 
        public static function patchModel($model, $options = [])
        {
                        /** @var \Laraeast\LaravelBootstrapForms\BsForm $instance */
                        return $instance->patchModel($model, $options);
        }
                    /**
         * Close the form tag.
         *
