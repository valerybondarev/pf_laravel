...
<div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
    ...
    <form id="upload-container" method="post" enctype="multipart/form-data" action="/upload">
        @csrf              <!-- с версии Laravel 5.6 -->
        {{ csrf_field() }} <!-- до версии Laravel 5.5 -->

        <img id="upload-image" src="https://img.icons8.com/?size=512&id=cFp23Lr2MzW0&format=png">
        <div>
