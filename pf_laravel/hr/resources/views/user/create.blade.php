...
@section('content')
    ...
    @auth
        <form method="post" action="{{ route('user.createPdf') }}" enctype="multipart/form-data">
            @csrf

            <div class="container">
                <div class="personal__block">
                    <p class="personal__pdf">Загрузите .pdf с hh.ru</p>
                    <input type="file" name="pdf" class="personal_pdf">
                    <button type="submit" class="pdf__btn content__btn button">Загрузить</button>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <section class="personal">
            <div class="personal__container">
                ...
                <input hidden class="personal__input personal__input--first input" type="text" id="fam" name="name{{ $prefix }}"
                       placeholder="@lang('site.name_surname')" value="{{ ($worker->name) }}">
                ...
                <input class="personal__input personal__input--first input" type="text" id="f_n" name="first_name{{ $prefix }}"
                       placeholder="@lang('site.first_name')" value="{{ ($worker->first_name) ? $worker->first_name : old('first_name' . $prefix) ?? '' }}" required>
                ...
                <input class="personal__input personal__input--first input" type="text" id="l_n" name="last_name{{ $prefix }}"
                       placeholder="@lang('site.last_name')" value="{{ ($worker->last_name) ? $worker->last_name : old('last_name' . $prefix) ?? '' }}">
                ...
                <input class="personal__input personal__input--first input" type="text" id="m_n" name="middle_name{{ $prefix }}"
                       placeholder="@lang('site.middle_name')" value="{{ ($worker->middle_name) ? $worker->middle_name : old('middle_name' . $prefix) ?? '' }}">
        ...
        <section class="skill">
            <div class="skill__unit">
                ...
                <div class="skill__part">
                    <label class="skill__label label" for="level">@lang('site.level')</label>
                    <select class="personal__input personal__input--second input" name="level_id" id="level_id">
                        <option></option>
                        @foreach($levels as $level)
                            <option value="{{ $level->id }}" {{ old('level_id') && old('level_id') == $level->id ? 'selected' : ''}}>
                                {{ $level->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="skill__part">
                    <label class="skill__label label" for="languages">@lang('site.languages')</label>
